...
public:
    ...
    shared_ptr<Material> createMaterial(vec3 a, vec3 d, vec3 s, float beta, float opacity, MATERIAL_TYPES t, vec3 kt, float nut);
    MATERIAL_TYPES getIndexType (shared_ptr<Material> m);
    MATERIAL_TYPES getIndexType (Material * m);

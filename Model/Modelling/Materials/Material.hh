...
public:
    ...
    Material(vec3 a, vec3 d, vec3 s, float shininess, float opacity, vec3 t, float nu);
    ~Material();
    ...
    float nut; //coeficiente calculado de refracción entre el material de entrada y salida
    float shininess;
